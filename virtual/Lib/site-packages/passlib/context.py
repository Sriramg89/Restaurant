...
class CryptPolicy(object):
    ...
    def from_sources(cls, sources, _warn=True):
        ...
        for source in sources:
            kwds.update(cls.from_source(
                source, _warn=False)._context.to_dict(resolve=True))
    ...
    def iter_config(self, ini=False, resolve=False):
        ...
        if ini:
            ...
            def render_value(value): return value
        return (
...
class _CryptConfig(object):
    ...
    def _init_default_schemes(self):
        ...
        if not default:
            for scheme in schemes:
                ...
                raise ValueError(
                    "must have at least one non-deprecated scheme")
        ...
        for handler in self.handlers:
            ...
            for cat in categories:
                ...
                if cat is None or has_cat_options:
                    records[scheme, cat] = self._create_record(
                        handler, cat, **kwds)
    ...
    def _get_record_options_with_flag(self, scheme, category):
        ...
        """
        # get scheme options
        kwds, has_cat_options = self.get_scheme_options_with_flag(
            scheme, category)
...
class CryptContext(object):
    ...
    def update(self, *args, **kwds):
        ...
        if args:
            ...
            if kwds:
                raise TypeError(
                    "positional arg and keywords mutually exclusive")
