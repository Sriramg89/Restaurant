...
class AppWalletTest(TestCase):
    ...
    def test_default_tag(self):
        ...
        wallet = AppWallet(
            {"1": "one", "02": "two", "A": "aaa"}, default_tag="1")
    ...
    def test_decrypt_key(self):
        ...
        temp = CIPHER1.copy()
        temp.update(t='2')
        self.assertEqual(wallet.decrypt_key(
            temp)[0], b'\xafD6.F7\xeb\x19\x05Q')
...
class TotpTest(TestCase):
    ...
    vectors = [
        ...
        [dict(key="JBSWY3DPEHPK3PXP", digits=6),
         (1409192430, '727248'), (1419890990, '122419')],
        [dict(key="JBSWY3DPEHPK3PXP", digits=9, period=41),
        ...
        [dict(key=RFC_KEY_BYTES_20, format="raw", period=60),
         (1111111111, '19360094')],
        [dict(key=RFC_KEY_BYTES_32, format="raw", alg="sha256",
              period=60), (1111111111, '40857319')],
        [dict(key=RFC_KEY_BYTES_64, format="raw", alg="sha512",
              period=60), (1111111111, '37023009')],
    ...
    def iter_test_vectors(self):
        ...
        for row in self.vectors:
            ...
            for entry in row[1:]:
                ...
                log.debug("test vector: %r time=%r token=%r expires=%r",
                          kwds, time, token, expires)
                otp = TOTP(**kwds)
    ...
    def test_ctor_w_size(self):
        ...
        with self.assertWarningList([
                dict(category=exc.PasslibSecurityWarning,
    ...
    def test_ctor_w_key_and_format(self):
        ...
        # .. w/ invalid char
        self.assertRaises(Base16DecodeError, TOTP,
                          'X01c630c2184b076ce99', 'hex')
    ...
    def test_using_w_now(self):
        ...
        self.assertRaisesRegex(AssertionError, msg_re,
    ...
    def test_normalize_token_instance(self, otp=None):
        ...
        # too few digits
        self.assertRaises(exc.MalformedTokenError,
    ...
    def assertTotpMatch(self, match, time, skipped=0, period=30, window=30, msg=''):
        ...
        self.assertEqual(match.expected_counter, expected,
                         msg=msg + " expected counter:")
    ...
    def test_match_w_window(self):
        ...
        assertRaises(exc.InvalidTokenError, token,
                     time + 2 * period, window=period)
    ...
    def test_match_w_reference_vectors(self):
        ...
        for otp, time, token, expires, msg in self.iter_test_vectors():
            ...
            self.assertRaises(exc.InvalidTokenError, match,
                              token, time + 100, window=0)
    ...
    def test_verify(self):
        ...
        # failed match
        source1 = dict(v=1, type="totp", key='otxl2f5cctbprpzx')
        self.assertRaises(exc.InvalidTokenError,
    ...
    def test_from_source(self):
        ...
        # json (bytes)
        otp = from_source(
            b'{"v": 1, "type": "totp", "key": "JBSWY3DPEHPK3PXP"}')
        self.assertEqual(otp.key, KEY4_RAW)
    ...
    def test_from_uri(self):
        ...
        # missing secret
        self.assertRaises(ValueError, from_uri,
                          "otpauth://totp/Example:alice@google.com?digits=6")
        ...
        with self.assertWarningList([
            dict(category=exc.PasslibRuntimeWarning,
    ...
    def test_to_uri(self):
        ...
        self.assertRaises(ValueError, otp.to_uri,
                          "alice@google.com", "issuer:with:semicolons")
    ...
    def test_from_dict(self):
        ...
        # --------------------------------------------------------------------------------
        otp = from_dict(dict(v=1, type="totp", key=KEY4,
                             label="alice@google.com", issuer="Example"))
        self.assertIsInstance(otp, TOTP)
        self.assertEqual(otp.key, KEY4_RAW)
        self.assertEqual(otp.label, "alice@google.com")
        self.assertEqual(otp.issuer, "Example")
        ...
        # invalid version
        self.assertRaises(ValueError, from_dict,
                          dict(v=0, type="totp", key=KEY4))
        self.assertRaises(ValueError, from_dict, dict(
            v=999, type="totp", key=KEY4))
        ...
        # secret case insensitive
        otp = from_dict(dict(v=1, type="totp", key=KEY4.lower(),
                             label="alice@google.com", issuer="Example"))
        self.assertEqual(otp.key, KEY4_RAW)
        ...
        otp = from_dict(dict(v=1, type="totp", key=KEY4,
                             label="Alice Smith", issuer="Provider1"))
        self.assertEqual(otp.label, "Alice Smith")
        self.assertEqual(otp.issuer, "Provider1")
        ...
        # digits out of range / invalid
        self.assertRaises(TypeError, from_dict, dict(
            v=1, type="totp", key=KEY4, digits="A"))
        self.assertRaises(ValueError, from_dict, dict(
            v=1, type="totp", key=KEY4, digits=15))
        ...
        # reject period < 1
        self.assertRaises(ValueError, from_dict, dict(
            v=1, type="totp", key=KEY4, period=0))
        self.assertRaises(ValueError, from_dict, dict(
            v=1, type="totp", key=KEY4, period=-1))

        # --------------------------------------------------------------------------------
        # unrecognized param
        # --------------------------------------------------------------------------------
        self.assertRaises(TypeError, from_dict, dict(
            v=1, type="totp", key=KEY4, INVALID=123))
