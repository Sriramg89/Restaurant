...
class HtpasswdFileTest(TestCase):
    ...
    def test_02_set_password_autosave(self):
        ...
        ht = apache.HtpasswdFile(
            path, default_scheme="plaintext", autosave=True)
        ht.set_password("user1", "pass2")
    ...
    def test_02_set_password_default_scheme(self):
        ...
        # default
        self.assertEqual(
            check(None), apache.htpasswd_defaults["portable_apache_22"])
...
class HtdigestFileTest(TestCase):
    ...
    def test_02_set_password(self):
        ...
        # invalid user
        self.assertRaises(ValueError, ht.set_password,
                          "user:", "realm", "pass")
        self.assertRaises(ValueError, ht.set_password,
                          "u"*256, "realm", "pass")
    ...
    def test_03_users(self):
        ...
        self.assertEqual(sorted(ht.users("realm")), [
                         "user1", "user2", "user3", "user4", "user5"])
    ...
    def test_04_check_password(self):
        ...
        # invalid user
        self.assertRaises(ValueError, ht.check_password,
                          "user:", "realm", "pass")
    ...
    def test_08_get_hash(self):
        """test get_hash()"""
        ht = apache.HtdigestFile.from_string(self.sample_01)
        self.assertEqual(ht.get_hash("user3", "realm"),
                         "a500bb8c02f6a9170ae46af10c898744")
        self.assertEqual(ht.get_hash("user4", "realm"),
                         "ab7b5d5f28ccc7666315f508c7358519")
        self.assertEqual(ht.get_hash("user5", "realm"), None)

        with self.assertWarningList("find\(\) is deprecated"):
            self.assertEqual(ht.find("user4", "realm"),
                             "ab7b5d5f28ccc7666315f508c7358519")
