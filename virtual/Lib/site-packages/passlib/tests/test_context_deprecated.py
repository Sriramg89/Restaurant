...
"""
    ...
    sample_config_1prd = dict(
        schemes=[hash.des_crypt, hash.md5_crypt,
                 hash.bsdi_crypt, hash.sha512_crypt],
...
"""
    ...
    def test_01_from_path_simple(self):
        ...
        self.assertRaises(EnvironmentError,
                          CryptPolicy.from_path, path + 'xxx')
    ...
    def test_01_from_path(self):
        ...
        uc2 = to_bytes(self.sample_config_1s, "utf-16",
    ...
    def test_12_get_handler(self):
        ...
        self.assertRaises(KeyError, p1.get_handler,
                          "sha256_crypt", required=True)
...
class CryptContextTest(TestCase):
    ...
    def test_12_hash_needs_update(self):
        ...
        self.assertFalse(cc.hash_needs_update(
            '$1$J8HC2RCr$HcmM.7NxB2weSvlw2FgzU0'))

        # check min rounds
        self.assertTrue(cc.hash_needs_update(
