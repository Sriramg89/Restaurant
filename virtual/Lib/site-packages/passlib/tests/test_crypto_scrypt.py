...
class ScryptEngineTest(TestCase):
    ...
    def test_bmix(self):
        ...
        def check_bmix(r, input, output):
            ...
            engine = ScryptEngine(r=r, n=1 << rng.randint(
                1, 32), p=rng.randint(1, 1023))
    ...
    def test_reference_vectors(self):
        ...
        for secret, salt, n, r, p, keylen, result in self.reference_vectors:
            ...
            if n > 16384 and self.backend == "builtin":
                ...
                continue
            log.debug("scrypt reference vector: %r %r n=%r r=%r p=%r",
                      secret, salt, n, r, p)
            self.assertEqual(scrypt_mod.scrypt(
                secret, salt, n, r, p, keylen), result)
...
class BuiltinScryptTest(_CommonScryptTest):
    ...
    def test_missing_backend(self):
        ...
        self.assertRaises(exc.MissingBackendError,
