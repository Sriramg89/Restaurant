...
class SkeletonTest(TestCase):
    ...
    def test_40_backends(self):
        ...
        # switch away from 'a' so next call actually checks loader
        d1.set_backend("b")
    ...
    def test_91_parsehash(self):
        ...
        self.assertEqual(
            result, {'checksum': u('AwTx2l6NADI'), 'salt': u('Og')})
        ...
        self.assertEqual(result, dict(
            salt=s, rounds=5000, implicit_rounds=True))
...
class PrefixWrapperTest(TestCase):
    ...
    def test_12_ident(self):
        ...
        # ... but requires prefix
        self.assertRaises(ValueError, uh.PrefixWrapper,
                          "h6", "des_crypt", ident=True)
