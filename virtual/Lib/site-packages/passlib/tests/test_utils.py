...
class MiscTest(TestCase):
    ...
    def test_utf8_truncate(self):
        ...
        for source in [
            ...
            # sanity check - should always be valid UTF8
            source.decode("utf-8")
...
class Base64EngineTest(TestCase):
    ...
    def test_ab64_decode(self):
        ...
        self.assertEqual(ab64_decode(b"abcdef"), hb(
            "69b71d79"))  # 2 mod 4, dirty padding bits
        self.assertEqual(ab64_decode(b"abcdeQ"), hb(
            "69b71d79"))  # 2 mod 4, clean padding bits
        self.assertEqual(ab64_decode(b"abcdefg"), hb(
            "69b71d79f8"))  # 3 mod 4, clean padding bits
    ...
    def test_b64s_decode(self):
        ...
        self.assertEqual(b64s_decode(b"abcdef"), hb(
            "69b71d79"))  # 2 mod 4, dirty padding bits
        self.assertEqual(b64s_decode(b"abcdeQ"), hb(
            "69b71d79"))  # 2 mod 4, clean padding bits
        self.assertEqual(b64s_decode(b"abcdefg"), hb(
            "69b71d79f8"))  # 3 mod 4, clean padding bits
...
class _Base64Test(TestCase):
    ...
    def test_encode_transposed_bytes(self):
        ...
        self.assertRaises(
            TypeError, engine.encode_transposed_bytes, u("a"), [])
    ...
    def check_int_pair(self, bits, encoded_pairs):
        ...
        for i in irange(100):
            ...
            self.assertGreaterEqual(
                value, 0, "decode %r out of bounds:" % encoded)
