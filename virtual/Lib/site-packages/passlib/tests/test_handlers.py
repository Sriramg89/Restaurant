...
_omitted_backend_tests = ["django_bcrypt",
                          "django_bcrypt_sha256", "django_argon2"]
...
class hex_md5_test(HandlerCase):
    ...
    def test_mock_fips_mode(self):
        ...
        self.assertRaisesRegex(UnknownHashError, pat,
...
class ldap_plaintext_test(HandlerCase):
    ...
    class FuzzHashGenerator(HandlerCase.FuzzHashGenerator):
        ...
        def random_password(self):
            # NOTE: this hash currently rejects the empty string.
            while True:
                pwd = super(ldap_plaintext_test.FuzzHashGenerator,
...
# create test cases for specific backends
ldap_md5_crypt_os_crypt_test = _ldap_md5_crypt_test.create_backend_case(
    "os_crypt")
ldap_md5_crypt_builtin_test = _ldap_md5_crypt_test.create_backend_case(
    "builtin")
...
# create test cases for specific backends
ldap_sha1_crypt_os_crypt_test = _ldap_sha1_crypt_test.create_backend_case(
    "os_crypt")
...
class _md5_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ('4lpHa N|_|M3r1K W/ Cur5Es: #$%(*)(*%#',
         '$1$jQS7o98J$V6iTcr71CGgwW2laf17pi1'),
...
class msdcc_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ((u("\u00FC\u00FC"), u("\u00FC\u00FC")),
         "593246a8335cf0261799bda2a2a9c623"),
...
class msdcc2_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (("longpassword", "twentyXXX_characters"),
         "cfc6a1e33eb36c3d4f84e4c2606623d2"),
        (("longpassword", "twentyoneX_characters"),
         "99ff74cea552799da8769d30b2684bee"),
...
#    accepts_all_hashes = True # TODO: turn this off.
    ...
    def test_90_special(self):
        ...
        self.assertEqual(handler.using().default_marker,
                         handler.default_marker)
        ...
        self.assertRaises(ValueError, handler.genhash,
                          'stub', "", marker='abc')
