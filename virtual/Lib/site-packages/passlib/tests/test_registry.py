...
class RegistryTest(TestCase):
    ...
    def test_register_crypt_handler_path(self):
        ...
        register_crypt_handler_path(
            "dummy_bad", "passlib.tests._test_bad_register")
    ...
    def test_register_crypt_handler(self):
        ...
        self.assertRaises(ValueError, register_crypt_handler, type(
            'x', (uh.StaticHandler,), dict(name=None)))
        self.assertRaises(ValueError, register_crypt_handler, type(
            'x', (uh.StaticHandler,), dict(name="AB_CD")))
        self.assertRaises(ValueError, register_crypt_handler, type(
            'x', (uh.StaticHandler,), dict(name="ab-cd")))
        self.assertRaises(ValueError, register_crypt_handler, type(
            'x', (uh.StaticHandler,), dict(name="ab__cd")))
        self.assertRaises(ValueError, register_crypt_handler, type(
            'x', (uh.StaticHandler,), dict(name="default")))
    ...
    def test_get_crypt_handler(self):
        ...
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", "handler names should be lower-case, and use underscores instead of hyphens:.*", UserWarning)
