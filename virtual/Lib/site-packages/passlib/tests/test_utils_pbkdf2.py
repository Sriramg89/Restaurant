...
class Pbkdf1_Test(TestCase):
    ...
    pbkdf1_tests = [
        ...
        #
        (b'password', hb('78578E5A5D63CB06'), 1000, 16,
         'sha1', hb('dc19847e05c64d2faf10ebfb4a3d2a20')),
        ...
        (b'password', b'salt', 1000, 16, 'md5',
         hb('8475c6a8531a5d27e386cd496457812c')),
        (b'password', b'salt', 1000, None, 'md5',
         hb('8475c6a8531a5d27e386cd496457812c')),
        (b'password', b'salt', 1000, None, 'sha1', hb(
            '4a8fd48e426ed081b535be5769892fa396293efb')),
    ]
    if not JYTHON:
        pbkdf1_tests.append(
            (b'password', b'salt', 1000, None, 'md4',
...
class Pbkdf2_Test(TestCase):
    ...
    def test_custom_prf(self):
        ...
        self.assertRaises(NotImplementedError, pbkdf2,
                          b'secret', b'salt', 1000, 20, prf)
