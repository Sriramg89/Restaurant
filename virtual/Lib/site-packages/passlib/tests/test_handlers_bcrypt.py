...
class _bcrypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (("0123456789"*26)
         [:254], '$2a$04$R1lJ2gkNaoPGdafE.H.16.1MKHPvmKwryeulRe225LKProWYwt9Oi'),
        (("0123456789"*26)
         [:255], '$2a$04$R1lJ2gkNaoPGdafE.H.16.1MKHPvmKwryeulRe225LKProWYwt9Oi'),
        (("0123456789"*26)
         [:256], '$2a$04$R1lJ2gkNaoPGdafE.H.16.1MKHPvmKwryeulRe225LKProWYwt9Oi'),
        (("0123456789"*26)
         [:257], '$2a$04$R1lJ2gkNaoPGdafE.H.16.1MKHPvmKwryeulRe225LKProWYwt9Oi'),
    ...
    def fuzz_verifier_pybcrypt(self):
        ...
        def check_pybcrypt(secret, hash):
            """pybcrypt"""
            secret = to_native_str(
                secret, self.FuzzHashGenerator.password_encoding)
...
class _bcrypt_sha256_test(HandlerCase):
    ...
    def test_calc_digest_v2(self):
        ...
        secret = "test"
        temp_digest = compile_hmac(
            "sha256", salt.encode("ascii"))(secret.encode("ascii"))
        temp_digest = b64encode(temp_digest).decode("ascii")
        self.assertEqual(
            temp_digest, "J5TlyIDm+IcSWmKiDJm+MeICndBkFVPn4kKdJW8f+xY=")
        ...
        self.assertTrue(bcrypt.verify(
            temp_digest, "$2b$12$" + salt + bcrypt_digest))
...
bcrypt_sha256_pybcrypt_test = _bcrypt_sha256_test.create_backend_case(
    "pybcrypt")
bcrypt_sha256_bcryptor_test = _bcrypt_sha256_test.create_backend_case(
    "bcryptor")
