...
def raw_sun_md5_crypt(secret, rounds, salt):
    ...
    while round < real_rounds:
        ...
        x = 0
        xrounds = X_ROUNDS_1 if (
            rval((round >> 3) & 15) >> (round & 7)) & 1 else X_ROUNDS_0
        ...
        y = 0
        yrounds = Y_ROUNDS_1 if (
            rval(((round+64) >> 3) & 15) >> (round & 7)) & 1 else Y_ROUNDS_0
