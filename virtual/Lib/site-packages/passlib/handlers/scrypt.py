...
class scrypt(uh.ParallelismMixin, uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.HasManyIdents,
    ...
    # ------------------------
    name = "scrypt"
    setting_kwds = ("ident", "salt", "salt_size",
    ...
    def using(cls, block_size=None, **kwds):
        ...
        try:
            _scrypt.validate(1 << cls.default_rounds,
                             cls.block_size, cls.parallelism)
        except ValueError as err:
            raise suppress_cause(ValueError(
    ...
    def to_string(self):
        ...
        if ident == IDENT_SCRYPT:
            ...
            try:
                ...
                raise suppress_cause(NotImplementedError(
