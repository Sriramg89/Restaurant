...
TYPE_I = u("i")
TYPE_D = u("d")
# new 2016-10-29; passlib 1.7.2 requires backends new enough for support
TYPE_ID = u("id")
...
class _Argon2Common(uh.SubclassBackendMixin, uh.ParallelismMixin,
    ...
    def using(cls, type=None, memory_cost=None, salt_len=None, time_cost=None, digest_size=None,
        ...
        if memory_cost is not None:
            ...
            subcls.memory_cost = subcls._norm_memory_cost(
                memory_cost, relaxed=relaxed)
    ...
    def _finalize_backend_mixin(mixin_cls, name, dryrun):
        ...
        for type in ALL_TYPES:
            ...
            warn("%r lacks support for all known hash types" %
                 name, uh.exc.PasslibRuntimeWarning)
